...
import com.epam.lab.group1.facultative.config.security.WebSecurityApplicationInitializer;
...
public class WebApplicationInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    protected Class<?>[] getRootConfigClasses() {
        return new Class[]{MainContextConfig.class, DaoConfig.class, WebConfig.class,
            WebSecurityApplicationInitializer.class};
    }
