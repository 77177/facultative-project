...
VALUES (5, 1, -1, 'feed back bad');

INSERT INTO student_course(student_id, course_id, mark, feedback)
VALUES (6, 1, 3, 'feedback good');

INSERT INTO student_course(student_id, course_id, mark, feedback)
VALUES (7, 1, 2, 'excellent');

INSERT INTO student_course(student_id, course_id, mark, feedback)
VALUES (8, 1, 0, 'not bad');

INSERT INTO student_course(student_id, course_id, mark, feedback)
VALUES (9, 1, 7, 'could be better');

--course 2
INSERT INTO student_course(student_id, course_id, mark, feedback)
VALUES (5, 2, 4, 'Good performance');

INSERT INTO student_course(student_id, course_id, mark, feedback)
VALUES (6, 2, 5, 'Awful performance');
